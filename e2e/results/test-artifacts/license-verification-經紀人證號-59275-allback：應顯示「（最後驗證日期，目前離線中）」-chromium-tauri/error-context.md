...
- Name: license-verification.spec.ts >> 經紀人證號驗證：debounce + 三態 UI + 離線 fallback + 7 天 cache >> 離線 fallback：應顯示「（最後驗證日期，目前離線中）」
- Location: e2e/license-verification.spec.ts:237:7
