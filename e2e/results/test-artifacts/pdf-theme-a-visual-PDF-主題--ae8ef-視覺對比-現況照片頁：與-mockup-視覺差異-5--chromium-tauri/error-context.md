...
- Name: pdf-theme-a-visual.spec.ts >> PDF 主題 A：淡雅 Minimal — 視覺對比 >> 現況照片頁：與 mockup 視覺差異 < 5%
- Location: e2e/pdf-theme-a-visual.spec.ts:139:7

# Error details

```
Error: A snapshot doesn't exist at /Users/fishtv/Development/products/AIRE/e2e/pdf-theme-a-visual.spec.ts-snapshots/theme-a-photos-chromium-tauri-darwin.png, writing actual.
```
