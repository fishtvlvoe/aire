...
- Name: license-verification.spec.ts >> 經紀人證號驗證：debounce + 三態 UI + 離線 fallback + 7 天 cache >> expired 態：過期證號應回 expired
- Location: e2e/license-verification.spec.ts:208:7
