...
- Name: license-verification.spec.ts >> 經紀人證號驗證：debounce + 三態 UI + 離線 fallback + 7 天 cache >> not_found 態：未登錄證號應回 not_found
- Location: e2e/license-verification.spec.ts:195:7
