...
- Name: pdf-theme-c-visual.spec.ts >> PDF 主題 C：科技優雅 Tech Elegant — 視覺對比 >> 基本資訊頁：與 mockup 視覺差異 < 5%
- Location: e2e/pdf-theme-c-visual.spec.ts:124:7

# Error details

```
Error: A snapshot doesn't exist at /Users/fishtv/Development/products/AIRE/e2e/pdf-theme-c-visual.spec.ts-snapshots/theme-c-basic-info-chromium-tauri-darwin.png, writing actual.
```
