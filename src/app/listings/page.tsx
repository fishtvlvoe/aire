                          ...
                          <td className='px-4 py-3'>
                            <div className='flex items-center justify-end gap-2 whitespace-nowrap'>
                              ...
                              <Link
                                ...
                                aria-label={resolveListingActionLabel({ id: listing.id, status: listing.status as 'draft' | 'field-visit-complete' | 'ready-for-generation' | 'documents-ready' })}
                                title={resolveListingActionLabel({ id: listing.id, status: listing.status as 'draft' | 'field-visit-complete' | 'ready-for-generation' | 'documents-ready' })}
                              ...
                              {/* 次要操作 icon（只在 documents-ready 顯示 = 回去補件） */}
                              {(() => {
