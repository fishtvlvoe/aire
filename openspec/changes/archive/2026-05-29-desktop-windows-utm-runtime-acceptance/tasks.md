...
- [x] 1.1 Validate proposal, design, specs, and tasks with `spectra analyze desktop-windows-utm-runtime-acceptance`.
- [x] 1.2 Validate the change with `spectra validate desktop-windows-utm-runtime-acceptance`.
...
- [x] 5.3 Satisfy `Address-to-COP smoke inside Windows` by running the address-to-COP smoke inside Windows.
- [x] 5.4 Capture PDF preview/export evidence from inside Windows.
