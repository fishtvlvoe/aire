...
- Affected specs: desktop-local-address-to-cop-e2e, land-registry-address-lookup, case-management, land-registry-billing-log, disclosure-document-generation
- Affected code:
  - Modified: `src/lib/land-registry-api.ts`, `src/lib/mock-backend.ts`, `src/app/(dashboard)/cases/new/page.tsx`, `src-tauri/src/land_registry/pull.rs`, `src-tauri/src/commands/cases.rs`, `src/lib/pdf-engine/assemble-dossier-data.ts`
